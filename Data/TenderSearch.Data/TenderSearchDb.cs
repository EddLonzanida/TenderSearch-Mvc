//------------------------------------------------------------------------------
// <auto-generated>
//  Last update:  Saturday, 15 December 2018 7:01 PM
...
namespace TenderSearch.Data
{
    public class TenderSearchDb : ApplicationDbContext
    {
        ...
        public DbSet<HasAllOptions> HasAllOptions { get; set; }

        public DbSet<HasCustomActionForIndex> HasCustomActionForIndexes { get; set; }
