    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => new { t.Group, t.SubGroup, t.Text }, unique: true, name: "IX_GroupAndText")
                .Index(t => new { t.Group, t.SubGroup, t.Value }, unique: true, name: "IX_GroupAndValue");
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Lookups", "IX_GroupAndValue");
            DropIndex("dbo.Lookups", "IX_GroupAndText");
