    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        PositionTitleId = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.PositionTitles", t => t.PositionTitleId, cascadeDelete: true)
                .Index(t => t.CompanyId)
                .Index(t => t.PositionTitleId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ContactPersons", "PositionTitleId", "dbo.PositionTitles");
            ...
            DropIndex("dbo.ContactPersons", new[] { "PositionTitleId" });
