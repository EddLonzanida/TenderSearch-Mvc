...
namespace TenderSearch.Web.Controllers.BaseClasses
{
    ...
    public abstract class CrudControllerForCreateEditDetailsDelete<T, TLayoutContentsCreateEditViewModel, TLayoutContentsDetailsDeleteViewModel>
        : CrudControllerBaseInt<T, IDataRepositoryBase<int, T>, TLayoutContentsCreateEditViewModel, LayoutContentsIndexViewModel<int, T>, TLayoutContentsDetailsDeleteViewModel>
    ...
    {
        protected CrudControllerForCreateEditDetailsDelete(IDataRepositoryBase<int, T> repository, ILogger logger)
            : this(null, repository, logger)
        {
        }

        protected CrudControllerForCreateEditDetailsDelete(IMediator mediator, IDataRepositoryBase<int, T> repository, ILogger logger)
